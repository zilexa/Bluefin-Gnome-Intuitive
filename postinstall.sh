  ...
  "policies": {
    ...
    "Preferences": {
      "browser.uiCustomization.state": {
        "Value": "{\"placements\":{\"widget-overflow-fixed-list\":[],\"unified-extensions-area\":[\"magnolia_12_34-browser-action\"],\"nav-bar\":[\"sidebar-button\",\"back-button\",\"forward-button\",\"stop-reload-button\",\"customizableui-special-spring1\",\"vertical-spacer\",\"downloads-button\",\"ublock0_raymondhill_net-browser-action\",\"urlbar-container\",\"customizableui-special-spring2\",\"unified-extensions-button\",\"sponsorblocker_ajay_app-browser-action\"],\"toolbar-menubar\":[\"menubar-items\"],\"TabsToolbar\":[],\"vertical-tabs\":[\"tabbrowser-tabs\"],\"PersonalToolbar\":[\"fxa-toolbar-menu-button\",\"firefox-view-button\",\"personal-bookmarks\"]},\"seen\":[\"developer-button\",\"magnolia_12_34-browser-action\",\"ublock0_raymondhill_net-browser-action\",\"sponsorblocker_ajay_app-browser-action\",\"screenshot-button\"],\"dirtyAreaCache\":[\"nav-bar\",\"vertical-tabs\",\"unified-extensions-area\",\"PersonalToolbar\",\"TabsToolbar\"],\"currentVersion\":23,\"newElementCount\":5}",
        "Status": "default"
      }
    },
    "Extensions": { 
